...
class Country {
    ...
    private Country(String nameCode, String phoneCode, String name) {
    ...
    static List<Country> getCustomMasterCountryList(CountryCodePicker codePicker) {
     ...
     * or returns null if no country matches given code.
     */
    static Country getCountryForNameCodeFromCustomMasterList(List<Country> customMasterCountriesList, CountryCodePicker.Language language, String nameCode) {
     ...
     * or returns null if no country matches given code.
     */
    static Country getCountryForNameCodeFromLibraryMasterList(CountryCodePicker.Language language, String nameCode) {
     ...
     */
    private static int getFlagResID(Country country) {
     ...
     */
    private static List<Country> getLibraryMasterCountryList(CountryCodePicker.Language language) {
        switch (language) {
            case ARABIC:
    ...
    private static List<Country> getLibraryMasterCountriesEnglish() {
        List<Country> countries = new ArrayList<>();
    ...
    private static List<Country> getLibraryMasterCountriesHindi() {
        List<Country> countries = new ArrayList<>();
    ...
    private static List<Country> getLibraryMasterCountriesFrench() {
        List<Country> countries = new ArrayList<>();
        countries.add(new Country("af", "93", "Afghanistan"));
    ...
    private static List<Country> getLibraryMasterCountriesGerman() {
        List<Country> countries = new ArrayList<>();
        countries.add(new Country("af", "93", "Afghanistan"));
    ...
    private static List<Country> getLibraryMasterCountriesJapanese() {
        List<Country> countries = new ArrayList<>();
    ...
    private static List<Country> getLibraryMasterCountriesSpanish() {
        List<Country> countries = new ArrayList<>();
    ...
    private static List<Country> getLibraryMasterCountriesSimplifiedChinese() {
        List<Country> countries = new ArrayList<>();
    ...
    private static List<Country> getLibraryMasterCountriesTraditionalChinese() {
        List<Country> countries = new ArrayList<>();
        countries.add(new Country("af", "93", "阿富汗"));
    ...
    private static List<Country> getLibraryMasterCountriesArabic() {
        List<Country> countries = new ArrayList<>();
    ...
    private static List<Country> getLibraryMasterCountriesPortuguese() {
        List<Country> countries = new ArrayList<>();
    ...
    private static List<Country> getLibraryMasterCountriesBengali() {
        List<Country> countries = new ArrayList<>();
    ...
    private static List<Country> getLibraryMasterCountriesRussian() {
        List<Country> countries = new ArrayList<>();
    ...
    private static List<Country> getLibraryMasterCountriesJavanese() {
        List<Country> countries = new ArrayList<>();
        countries.add(new Country("af", "93", "Afghanistan"));
        countries.add(new Country("al", "355", "Albania"));
        countries.add(new Country("dz", "213", "Algeria"));
    ...
    private static List<Country> getLibraryMasterCountriesKorean() {
        List<Country> countries = new ArrayList<>();
    ...
    private static List<Country> getLibraryMasterCountriesGujarati() {
        List<Country> countries = new ArrayList<>();
    ...
    private static List<Country> getLibraryMasterCountriesHebrew() {
        List<Country> countries = new ArrayList<>();
